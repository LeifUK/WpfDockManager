...
namespace OpenControls.Wpf.DockManager
{
    internal class FloatingPaneManager : IFloatingPaneManager
    {
        ...
        private void FloatingPane_StartDrag(object sender, EventArgs e)
        {
        ...
        private void RegisterFloatingPane(FloatingPane floatingPane)
        {
            ...
            if (floatingPane is FloatingDocumentPaneGroup)
            {
        ...
        {
            IFloatingPaneHost.ActiveDocumentChanged(sender as FloatingDocumentPaneGroup);
        }
